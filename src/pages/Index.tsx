        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="fade-up-section">
              <img alt="Senator at work" src="/lovable-uploads/e3aae050-31d0-41f6-9827-0ec97b9118bc.jpg" className="timeline-image shadow-xl w-full h-[500px] rounded object-scale-down" />
            </div>
            <div className="fade-up-section">
